...
class quickdraw_container : public litehtml::document_container
{
    public:
        ...
        litehtml::uint_ptr create_font(const litehtml::tchar_t *face_name, int size, int weight, litehtml::font_style italic, unsigned int decoration, litehtml::font_metrics *fm);
        ...
        void load_image(const litehtml::tchar_t *src, const litehtml::tchar_t *base_url, bool redraw_on_ready);
        void get_image_size(const litehtml::tchar_t *src, const litehtml::tchar_t *base_url, litehtml::size& sz);
